...
; P7.20 shell beep reaches this same synchronous service after both operands pass safe expression conversion; qualification also rechecks direct half-note service behavior.
