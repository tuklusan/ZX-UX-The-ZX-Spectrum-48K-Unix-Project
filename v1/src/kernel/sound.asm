...
; P7.20 shell beep reaches this same synchronous service after both operands pass safe expression conversion; qualification rechecks converter output and direct half-note service behavior independently.
