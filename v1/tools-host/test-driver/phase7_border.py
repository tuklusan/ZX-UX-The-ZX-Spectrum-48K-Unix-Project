...
def _source(root:Path):
    ...
    return [
      ...
      {"name":"border-validates-reserved-h-and-color-before-commit","passed":b.index("or a")<b.index("call zx48_ula_set_border") and b.index("cp 8")<b.index("call zx48_ula_set_border")},
