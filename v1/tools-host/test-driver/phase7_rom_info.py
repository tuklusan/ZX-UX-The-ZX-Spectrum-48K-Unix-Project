...
def _source(root:Path):
    ...
    return [
      ...
      {"name":"fixed-record-layout-size-24","passed":"ROMINFO_RECORD_SIZE      EQU 24" in rom and "defs 16-@strlen(nameText),0" in rom},
      ...
      {"name":"class-c-usr-is-metadata-only","passed":'ROMINFO_REC "USR",$34BC,ROMINFO_CLASS_C' in p},
