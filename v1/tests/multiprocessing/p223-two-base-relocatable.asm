...
;
; P2.23 deterministic two-base relocatable execution fixture.
...
zx48_process_lookup:
    cp MAX_PROCESSES
    jr nc,p223_process_noent
    ld ix,process_table
    or a
    jr z,p223_process_have_ptr
    ld b,a
    ld de,PROC_DESC_SIZE
p223_process_ptr_loop:
    add ix,de
    djnz p223_process_ptr_loop
p223_process_have_ptr:
    ld a,(ix+PROC_STATE)
    or a
    jr z,p223_process_noent
    xor a
    ret
p223_process_noent:
    ld a,E_NOENT
...
zx48_process_count:
    ...
    ld c,0
p223_process_count_loop:
    ld a,(ix+PROC_STATE)
    or a
    jr z,p223_process_count_next
    inc c
p223_process_count_next:
    ld de,PROC_DESC_SIZE
    add ix,de
    djnz p223_process_count_loop
    ld a,c
    or a
    ret

zx48_spawn_resolve_ram_object:
    ld ix,P223_GOOD_RECORD
    xor a
    ret
...
p223_end:
    ASSERT p223_end <= FAST_RESERVE_START
    SAVEBIN "../../build/p223-two-base-relocatable.bin",p223_start,p223_end-p223_start
