...
2. Revision 13 / Revision 04 and Revision 14 / Revision 05 are frozen, never-activated historical prospective authority pairs. Revision 14 itself is frozen at SHA-256 `868d6605733061fec00fb82c051e9ab02915041e5e26ddc1563a3c488bc82324`; Revision 05 itself is frozen at its actual SHA-256 `2a7a84e01fd2016b4dfd5421d1510f2474ef7559ee1dea584bbb98d11811e047`. Revision 05 contains stale Revision-13 architecture-identity text and stale `Revision-14/04` bridge labels, so `R14.00` was never admissible and MUST NOT be used. None of REV13/REV04/REV14/REV05 may be edited in place or activated.
3. `docs/01-ZX-UX-ARCHITECTURE-REV15.md` and `docs/02-ZX-UX-IMPLEMENTATION-STEPS-REV06.md` are the current dormant prospective authorities. Their exact identities are pinned here: REV15 SHA-256 `c80b0626d58d79b133de90ee64e598421618ce5c503d6f5d34c866e332e4c398`; REV06 SHA-256 `aeba14b8baa5387b98c158ac00ee9d81e93a162807769497068dac1adc0c8624`. The H06 correction carried forward by those exact bytes is pinned to read-only SDK commit `9ca3c6d6b5dd4b6e2351c1800afbd47d1d77e411`, `usr/src` tree `f629dcc1d156b83bf08ed171b9273e3cbb621ad1`, `usr/src/examples/hello.c` Git blob `95fa0186bda3f7636774f5885988d78a13f6450b`, 703 bytes, SHA-256 `6f94a735f230dadf5928993f9a071f3f47e98b63d18230eef102f6ae7b63e4b2`, and direct declaration dependency `usr/src/examples/exapi.h`, 2056 bytes, SHA-256 `2fa0edc593832d3ab57bc105233f41fd81a02b1f3ea022cefc42da01a6084bb8`. Any different REV15/REV06 bytes or H06 canary/header identity fail closed and require a new prospective revision pair.
4. Because Phase 2 and its aggregate are already PASS, `R15.00` may execute once the REV15/REV06 publication is present and the repository is otherwise clean. It MUST execute exactly as defined by Revision 06. The bridge must preserve and verify historical REV12/REV03 identities and Phase-2 evidence, certify the bounded REV15 delta and carried-forward current-tree regressions, advance prospective certification tooling, certify one clean bridge source-candidate commit, and admit only the frozen `R15.00` records in a subsequent evidence-only admission commit.
5. Phase 3 is forbidden until the evidence-only `R15.00` admission commit exists, `v1/dist/certification/R15.00.result.json` records PASS for the exact pinned REV15 architecture identity and exact pinned REV06 implementation-plan identity, and every mandatory automated validation triggered by that admission commit has completed successfully. `P3.01` is the first ordinary phase step permitted after all those conditions are satisfied.
6. After all conditions in item 5 are satisfied, Revision 15 / Revision 06 become the controlling authorities for Phase 3 and all later prospective certification. Historical E0-P2 evidence remains historical read-only evidence under Revision 12 / Revision 03; frozen REV13/REV04 and REV14/REV05 remain never-activated historical prospective revisions.
7. A failed or incomplete `R15.00` leaves completed Phase-2 history intact but leaves the Phase-3 transition closed. Correct any bridge defect through the normal SoP/review/check-in cycle and rerun the bridge; do not mutate frozen canonical revisions to force admission and do not begin `P3.01`.
...
6. Any documentation-only publication that adds REV15/REV06, whether during Phase 2 or after `P2.24`, follows the same documentation-only runner exclusion. That publication is not an `R15.00` PASS and must not be treated as active authority for Phase 2 or Phase 3. The later `R15.00` source-candidate and evidence-only admission transactions follow Section 1.1 and Revision 06 in addition to this normal check-in flow.
...
GARF continuity may span the Revision 12 / Revision 03 and Revision 15 / Revision 06 epochs. Carrying an earlier result identifier forward is historical continuity only: it does not change the active architecture/plan authority, does not satisfy `R15.00`, and does not relabel or upgrade historical E0-P2 certification evidence. The admitted durable `R15.00.result.json` PASS, its exact document identities, and successful mandatory validation of the evidence-only admission commit together form the sole Phase-2-to-Phase-3 authority transition.
