...
def main():
    ...
    try:
        ...
        if not isinstance(phase_lock,str) or len(phase_lock)!=64: raise E("P8.40 result toolchain")
        names=[]; manifest={}
        for n in range(1,41):
            step=f"P8.{n:02d}"
        ...
        print("ZX-UX PHASE 8 EVIDENCE FINALIZATION PASS")
        return 0
    except Exception as exc:
        print(f"ZX-UX PHASE 8 EVIDENCE FINALIZATION FAIL: {exc}",file=sys.stderr)
        return 1
