...
declare -A explicit_header_exemptions=(
  ...
  ["v1/dist/cassette/phase-0/p009-bootstrap.tap"]="Binary recovered ZX Spectrum certification media cannot carry the plaintext project header."
  ["v1/dist/cassette/phase-0/p010-boot.tap"]="Binary recovered ZX Spectrum certification media cannot carry the plaintext project header."
